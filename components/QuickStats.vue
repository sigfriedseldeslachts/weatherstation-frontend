  ...
  <div>
    <h3 class="flex gap-2 items-center">
      ...
      <span class="badge badge-green">
        <svg class="badge-dot" fill="currentColor" viewBox="0 0 8 8">
            ...
            <div class="w-0 flex-1">
              ...
              <dd class="flex items-baseline">
                <div>
                  ...
                  <div class="flex mt-1 text-sm gap-2">
                    <button type="button" @click.prevent="openInfoModal(key)" v-if="$sensors.getSensorAttr(key, 'moreInfo')" class="font-medium text-green-600 hover:text-green-500" v-t="'moreInfo'" />
                    <span class="badge badge-red" v-t="'sensorOverload'" v-if="$sensors.isSensorOverload(key, value)" />
                  </div>
                </div>
